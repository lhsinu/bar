...
class BluetoothClassicBackManager {
    companion object {
        // Debugging
        private const val TAG = "BluetoothBackManager"
        ...
        private const val NAME = "BluetoothBackManager"
        ...
        private var mInstance: BluetoothClassicBackManager = BluetoothClassicBackManager()
        fun getInstance(): BluetoothClassicBackManager {
            return mInstance
        }
    }
    ...
    private inner class AcceptThread : Thread() {
        ...
        override fun run() {
            ...
            while (this@BluetoothClassicBackManager.state != STATE_CONNECTED) {
                try {
                    // This is a blocking call and will only return on a
                    // successful connection or an exception
                    if (mmServerSocket != null) {
                        this@BluetoothClassicBackManager.state = STATE_CONNECTING
                        socket = mmServerSocket.accept()
                    }
                } catch (e: IOException) {
                    this@BluetoothClassicBackManager.state = STATE_NONE
                ...
                if (socket != null) {
                    when (this@BluetoothClassicBackManager.state) {
...
//                tmp = mmDevice.createRfcommSocketToServiceRecord(MY_UUID)
        ...
        override fun run() {
            ...
            try {
                ...
                this@BluetoothClassicBackManager.start()
                return
            }

            // Reset the ConnectThread because we're done
            synchronized(this@BluetoothClassicBackManager) {
                mConnectThread = null
            }
